...
if (isset($_POST['update'])) 
{
    ...
    $result = mysqli_query($con, "UPDATE produk SET NamaProduk='$NamaProduk', Harga=$Harga, Stok=$stok, foto=$foto WHERE ProdukID=$id");
                    ...
                    <form class="pt-3 mt-3" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <p style="color: red;">Hanya Bisa Menginput foto dengan ekstensi PNG, JPEG, SVG</p>
                            </div>
                        </div>
